...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`dpkgGenerator.py`           | Generates random synthetic logs   |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`dpkgReceiver.py`           | Extracts and inserts the new random synthetic logs created by dpkgGenerator   |
...
| &nbsp;&nbsp;&nbsp;&nbsp;`dpkg_synthetic.log`                                          | Stores the new random synthetic logs generated by dpkgGenerator                         |
...
Guarantee that the sequence of execution is as follows:
